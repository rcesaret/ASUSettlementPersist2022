...
#AggSite polygons
writeOGR(All_Agg_SitePoly, paste0(wd$data_p,"SBOM_Agg_SitePoly6.gpkg"), "SBOM_Agg_SitePoly6", driver = "GPKG", overwrite_layer=TRUE)

#Catchment areas
writeOGR(All_Agg_CatchPoly, paste0(wd$data_p,"SBOM_Agg_CatchPoly6.gpkg"), "SBOM_Agg_CatchPoly6", driver = "GPKG", overwrite_layer=TRUE)
