...
# Package names
packages <- c("rgdal", "rgeos", "sp", "sf", "GISTools", "raster", "Matrix", "gdistance", "lwgeom", "tidyverse", "tidyr", "stars", "dismo", "purrr", "spatialEco", "whitebox", "classInt", "deldir")#, "data.table", "zoo", "era", "JOPS", "mgcv","igraph", "ggnewscale", "ggrepel","ggridges", "movecost",  "datplot", "scales",
...
--Create function that lets you 
----pick which spatial network model to calculate
----input cost-distance matrix --> edge weights
----input stars raster basemap
----create weighted and unweighted undirected graphs
----determine distances among all settlements using shortest path distances weighted graph https://igraph.org/r/doc/distances.html https://book.archnetworks.net/exploratory#WalksPathsDistance
----output revised distance matrix
----calculates node network stats undirected graph https://book.archnetworks.net/exploratory#Centrality
----plot output: node size = a centrality metric; includes degree distribution and rank size scaling
--Add a set of graphs together
