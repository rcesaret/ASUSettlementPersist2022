...
#AggSite polygons
writeOGR(All_Agg_SitePoly, paste0(dir2,"SBOM_Agg_SitePoly7.gpkg"), "SBOM_Agg_SitePoly7", driver = "GPKG", overwrite_layer=TRUE)

#Catchment areas
writeOGR(All_Agg_CatchPoly, paste0(dir2,"SBOM_Agg_CatchPoly7.gpkg"), "SBOM_Agg_CatchPoly7", driver = "GPKG", overwrite_layer=TRUE)
