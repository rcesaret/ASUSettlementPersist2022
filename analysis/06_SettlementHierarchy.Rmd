...
## Local Concentration and Inequality
...
lctools::FLQ = Focal Location Quotient


Inequality = variability/diversity
...
lctools::gw_variable = Spatial Interaction Models: gw / regional variable
lctools::l.moransI = Local Moran’s I classic statistic for assessing spatial autocorrelation
lctools::lcorrel = Local Pearson and GW Pearson Correlation
lctools::mc.lcorrel = Monte Carlo simulation for the significance of the local correlation coefficients
lctools::w.matrix = Weights Matrix based on a number of nearest neighbours or a fixed distance
